  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-50 flex flex-col">
      <header className="px-4 pt-4 pb-3 border-b border-slate-800">
        ...
        <h1 className="text-xl font-bold mb-1">{workout.title}</h1>
        ...
        <section className="rounded-2xl bg-slate-900/80 border border-slate-800 p-4 space-y-3">
          ...
          <div className="grid grid-cols-3 gap-3 text-xs text-slate-300">
            ...
            <div>
              ...
              <p>{workout.totalVolumeKg} kg</p>
            </div>
            <div>
              <p className="uppercase tracking-wide text-[10px] text-slate-500">
                Sets
              </p>
              <p>{workout.totalDoneSets}</p>
            </div>
          </div>
        </section>
        ...
        <section className="space-y-3">
          ...
          {groupedExercises.map((ex) => (
            ...
            >
              ...
              <div className="mt-2 text-[11px] text-slate-500 grid grid-cols-3 gap-2 px-1">
                <span>Set</span>
              ...
              {ex.sets.map((s, idx) => (
                <div
                  key={s.id}
                  className="mt-1 grid grid-cols-3 gap-2 items-center rounded-xl px-2 py-1 bg-slate-900"
                >
